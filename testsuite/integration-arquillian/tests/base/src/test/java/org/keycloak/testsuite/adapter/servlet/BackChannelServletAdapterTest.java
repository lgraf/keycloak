...
public class BackChannelServletAdapterTest extends AbstractServletsAdapterTest {
    ...
    private static final String INVALID_FRONTCHANNEL_HOST = "keycloak.127.0.0.1.nip.io";
    ...
    protected static WebArchive tokenMinTTLPage() {
        return servletDeployment(TokenMinTTLPage.DEPLOYMENT_NAME, "keycloak-backchannel.json", AdapterActionsFilter.class, AbstractShowTokensServlet.class, TokenMinTTLServlet.class);
    }
